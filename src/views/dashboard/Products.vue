<template>
  <div class="products">
    ...
    <table class="table table-striped mt-3">
      <thead>
        <tr class="thead-dark">
          ...
          <th scope="col" width="10%" class="sort text-right">
            原價
          </th>
          <th scope="col" width="10%" class="sort text-right">
            售價
    ...
    <product-modal :submit="submit" ref="productModal" @update="getProducts"></product-modal>

    <del-product-modal :product-temp="productTemp" @update="getProducts"></del-product-modal>
